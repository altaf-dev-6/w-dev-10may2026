...
export default function DiodeLaserPage() {
  ...
  const categoryPosts = BLOG_POSTS.filter(p => p.category === "Diode Laser Machines");
      ...
      <main className="pt-20">
          ...
          <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="z-10 order-2 lg:order-1">
              ...
              <h1 className="text-5xl md:text-7xl font-headline font-extrabold text-on-surface leading-[1.1] mb-6 tracking-tight">
                Diode Laser Machine for <span className="text-primary-container">Clinics in India</span>
              </h1>
              <p className="text-xl text-on-surface-variant mb-10 max-w-xl leading-relaxed">
                Industry-leading precision meet PAN India installation support. Elevate your practice with Woxmen's advanced Diode Laser technology and 24/7 technical assistance.
              </p>
            ...
            <div className="relative order-1 lg:order-2">
              ...
              <img alt="Diode Laser Medical Device" className="relative z-10 w-full h-[500px] object-cover rounded-[2.5rem] shadow-2xl" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCmjrsnifmwoo0_UkVMPAKh67zoVKXVUkTgNKZKdpMuVsFGxpGMCGyjZuQ872lC9Mg3XcKcF25eHzUZ-PSMym7shU8vHeEbqtPfFE8QluaDjq_lI7J6kiQxbY_3P_Hyp8acCgFriLIkbzQr7uSQNQ1E8rhb_mw1F6YHuFmSEQuFCHAoXZSn63QUrFskMsS6jtNflZXasBOVLoin__WQtcGeXKlgDm2d1pEai7vZ9mcFzwBmPhLitvXeqLOjtqhBT8eXf8HvkCRdr-o" />
            </div>
          </div>
        </section>
        ...
        <section className="py-24 px-8 bg-surface-container-low">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-on-surface-variant max-w-2xl mx-auto">The Diode Laser combines safety, speed, and comfort in one unified clinical platform.</p>
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div className="space-y-8">
                  <div className="flex gap-6">
                    ...
                    <div>
                      ...
                      <p className="text-secondary leading-relaxed">The Diode Laser emits concentrated light energy that is absorbed specifically by the target chromophore without affecting surrounding tissues.</p>
                    </div>
                  </div>
                  <div className="flex gap-6">
              ...
              <div className="bg-primary-container p-12 rounded-[3rem] shadow-2xl rotate-1">
                ...
                <p className="text-primary-fixed/80 mb-8">Discuss the clinical outcomes of Diode Laser with our medical engineers.</p>
            ...
            <div className="space-y-4">
              <details className="group bg-surface-container-lowest rounded-2xl shadow-sm overflow-hidden" open>
                <summary className="flex items-center justify-between p-6 cursor-pointer list-none">
                  <span className="font-headline font-bold text-on-surface">Is Diode Laser safe for all Indian skin types?</span>
                  <span className="material-symbols-outlined transition-transform group-open:rotate-180">expand_more</span>
                </summary>
                <div className="px-6 pb-6 text-secondary leading-relaxed border-t border-surface-container">
                    Yes, our Diode Laser machines are specifically calibrated for Fitzpatrick skin types III to VI. The cooling technology ensures safety even at high fluences.
                </div>
              </details>
        ...
        <section className="py-24 px-8 bg-surface overflow-hidden">
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row items-end justify-between mb-8 gap-6">
              <div>
                <h2 className="text-3xl font-headline font-extrabold text-on-surface mb-2">Latest Insights on Diode Laser</h2>
        ...
        <section className="py-24 px-8 relative overflow-hidden bg-primary-container">
          ...
          <div className="max-w-7xl mx-auto relative z-10 text-center">
            <h2 className="text-4xl md:text-6xl font-headline font-extrabold text-white mb-8">Upgrade Your Clinic with <br className="hidden md:block"/>Diode Laser</h2>
